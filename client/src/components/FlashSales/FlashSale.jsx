...
import { Heart, Eye, ArrowLeft, ArrowRight, LogIn } from "lucide-react";
                ...
                >
                  <div className="cursor-pointer p-4 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div className="relative mb-4 group">
                      ...
                      >
                        <Heart
                          ...
                          className={
                            isInWishlist(product._id) ? "text-[#db4444]" : ""
                          }
                        />
                      </button>
                      <button
                    ...
                    <div className="flex items-center">
                      <span className="text-[#db4444] font-bold mr-2 text-sm sm:text-base">
                        {product.currency}
                        {product.price}
                      </span>
