    ...
    <>
      <div className="rounded-lg shadow-md overflow-hidden p-4 hover:shadow-xl transition-shadow duration-300 mb-10">
        <div className="relative">
          ...
          {product.discount && (
            <span className="absolute top-2 left-2 bg-[#db4444] text-white text-xs font-bold px-2 py-1 rounded">
              {product.discount}
            </span>
          )}
          <div className="absolute top-0 right-0 space-y-2 p-2">
            ...
            >
              <Heart
                className={`w-5 h-5 ${
                  isInWishlist ? "text-[#db4444] fill-current" : ""
                }`}
        ...
        <Button
          ...
          text="Add To Cart"
          className="secondaryColor py-3 w-full text-white"
        />
      </div>
