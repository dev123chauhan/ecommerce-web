...
//   const { data: shop, isLoading: productsLoading, error: productsError } = useGetProductsQuery();
...
//                       <li><Link to="" className="font-bold">Shop</Link></li>
//                     </ul>
//                   </nav>
...
//                   {!categoriesLoading && categories && Object.entries(categories).map(
